...
const API_URL = process.env.REACT_APP_USERS_API_URL || "http://10.0.4.41:3000/users/"; // enter what url your expo is running on + our port 3000
...
export const getUserPosts = async (userId) => {
    const response = await fetch(`http://10.0.4.41:3000/post/user/${userId}/posts`);
    if (!response.ok) {
