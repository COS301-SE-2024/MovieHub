...
const API_URL = process.env.REACT_APP_USERS_API_URL || 'http://10.32.146.210:3000/users' || 'http://localhost:3000/users';// enter what url your expo is running on + our port 3000
