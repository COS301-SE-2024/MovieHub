...
import { StyleSheet, Text, View, ScrollView, RefreshControl, TouchableOpacity, StatusBar, Animated, Platform, Image, Dimensions, FlatList } from "react-native";
        ...
        <ScrollView style={styles.container}>
            ...
            <Animated.FlatList
                ...
                renderItem={({ item, index }) => {
                    ...
                    return (
                        <View style={{ width: ITEM_SIZE, paddingBottom: 40 }}>
                            <Animated.View
                                style={{
           ...
           <View style={{ paddingTop:30 }}>
                ...
                <Post 
                    ...
                    uid={1}
                    username={"test"}
                    userAvatar={"https://www.gravatar.com/avatar/205e460b479e2e5b48aec07710c08d50"}
                    userHandle={"@test"}
                    likes={0}
                    comments={0}
